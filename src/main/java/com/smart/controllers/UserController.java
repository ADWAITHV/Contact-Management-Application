...
public class UserController {
	...
	try {
		...
		session.setAttribute("message",new Message("You contact is added","success"));
	...
	public String showContext(@PathVariable("page")Integer page, Model model,Principal principal)
	{
		String userName=principal.getName();
	...
	public String changePassword(@RequestParam("oldPassword") String oldPassword,@RequestParam("newPassword") String newPassword,Principal principal,HttpSession session)
	{
		...
		if(this.bCryptPasswordEncoder.matches(oldPassword, currentUser.getPassword()))
		{
			...
			session.setAttribute("message",new Message("Your password is successfully changed..","succcess"));
